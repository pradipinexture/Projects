			...
			<div class="row">
				...
				<div class="col-md-8 col-sm-12">
					<section class="form-section">
						<form action="<c:out value = "${formAction}"/>" id="register-form"
								...
								<c:choose>
									<c:when test="${empty addresses}">
										...
										<div class="form-group address-section">
											...
											<div class="add-style">
												<span> <select class="form-control city" 
													name="city">
												...
												</span> <span> <input type="number" class="form-control pincode"
													name="pincode"
									...
									<c:otherwise>
										<div class="addresses">
											<c:forEach var="addr" items="${addresses}" varStatus="count">
												...
												<div class="form-group address-section">
													<label for="address">Address :<c:out
													...
													<div class="add-style">
														<span> <select class="form-control" name="city"
															class="city<c:out value="${count.index}" />">
																<option value="not">Select City</option>
																<option value="botad">Botad</option>
																<option value="ahmedabad">Ahmedabad</option>
																<option value="baroda">Baroda</option>
														...
														</span> <span> <select class="form-control" name="state"
															class="state<c:out value="${count.index}" />">
																<option value="not">Select State</option>
																<option value="gujarat">Gujarat</option>
																<option value="rajasthan">Rajasthan</option>
																<option value="madhyapradesh">Madhyapradesh</option>
							...
							<div class="form-group demo-image">
								<label for="image">File input</label> <input type="file"
									...
									value="C:/Users/pradip/Desktop/Final Task DB Design.png">
...
$(document).ready(function(){
	...
	<c:if test="${sUser.roletype != null}">
	      ...
	      $('#imgPreview').attr('src', "data:image/jpg;base64,<c:out value="${user.imageString}" />");
	</c:if>
